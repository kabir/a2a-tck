...
class SendMessageConfiguration(_message.Message):
    ...
    history_length: int
    blocking: bool
    def __init__(self, accepted_output_modes: _Optional[_Iterable[str]] = ..., push_notification_config: _Optional[_Union[PushNotificationConfig, _Mapping]] = ..., history_length: _Optional[int] = ..., blocking: bool = ...) -> None: ...
...
class AgentInterface(_message.Message):
    __slots__ = ("url", "protocol_binding")
    URL_FIELD_NUMBER: _ClassVar[int]
    PROTOCOL_BINDING_FIELD_NUMBER: _ClassVar[int]
    url: str
    protocol_binding: str
    def __init__(self, url: _Optional[str] = ..., protocol_binding: _Optional[str] = ...) -> None: ...

class AgentCard(_message.Message):
    __slots__ = ("protocol_version", "name", "description", "supported_interfaces", "url", "preferred_transport", "additional_interfaces", "provider", "version", "documentation_url", "capabilities", "security_schemes", "security", "default_input_modes", "default_output_modes", "skills", "supports_authenticated_extended_card", "signatures", "icon_url")
...
class AgentCapabilities(_message.Message):
    __slots__ = ("streaming", "push_notifications", "extensions", "state_transition_history")
    ...
    def __init__(self, streaming: bool = ..., push_notifications: bool = ..., extensions: _Optional[_Iterable[_Union[AgentExtension, _Mapping]]] = ..., state_transition_history: bool = ...) -> None: ...
...
class ListTasksRequest(_message.Message):
    __slots__ = ("context_id", "status", "page_size", "page_token", "history_length", "last_updated_after", "include_artifacts", "metadata")
    CONTEXT_ID_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    ...
    metadata: _struct_pb2.Struct
    def __init__(self, context_id: _Optional[str] = ..., status: _Optional[_Union[TaskState, str]] = ..., page_size: _Optional[int] = ..., page_token: _Optional[str] = ..., history_length: _Optional[int] = ..., last_updated_after: _Optional[int] = ..., include_artifacts: bool = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
